...
do_train = False
objRegressor = regressor(args['prototxt'], args['model'], logger, args['gpuID'], 1, do_train)
objTracker = tracker(objRegressor) # Currently no idea why this class is needed, eventually we shall figure it out
...
objTrackerVis.trackVot(videos, 0, 1)